    ...
    >
        <form wire:submit="save" class="flex h-full min-w-0 w-full">
            <x-filament::section class="h-full w-full" style="width: 100%; height: 100%;">
                ...
                >
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-400 fi-wi-stats-overview-stat-label">{{ __('app.dashboard.total_open_stocks') }}</div>
                    <div class="max-w-full text-3xl font-bolder text-gray-950 dark:text-white sm:text-3xl" style="margin-top: 1rem; font-weight: 700;">
        ...
        <form wire:submit="save" class="flex h-full min-w-0 w-full">
            <x-filament::section class="h-full w-full" style="width: 100%; height: 100%;">
                ...
                <label for="wallet-save-cloud" class="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {{ __('app.dashboard.total_save_cloud') }}
                </label>
